...
def SetJetPackMode(objid, bypass_checks=False, do_hover=False, use=False, effect_id=-1, air_speed=60.0, max_air_speed=90.0, vertical_velocity=1.0, warning_effect_id=-1):
