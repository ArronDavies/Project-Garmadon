...
def LOAD_STATIC_ZONE(stream, conn, server):
    ...
    position = Vector3(server.zone_data.spawnpoint_pos_x, server.zone_data.spawnpoint_pos_y,
                       server.zone_data.spawnpoint_pos_z)
    rotation = Vector4(server.zone_data.spawnpoint_rot_x, server.zone_data.spawnpoint_rot_y,
                       server.zone_data.spawnpoint_rot_z, server.zone_data.spawnpoint_rot_w)
