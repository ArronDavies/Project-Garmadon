...
class Object(BaseData.BaseData):
	...
	def create(self):
		for component in self.component_ids:
			if component[0] == 3:
				simple_physics_dict = {'HasPosition': True, 'PosX': self.position_x, 'PosY': self.position_y, 'PosZ': self.position_z, 'RotX': self.rotation_x, 'RotY': self.rotation_y, 'RotZ': self.rotation_z, 'RotW': self.rotation_w}
			...
			if component[0] == 40:
				phantom_physics_dict = {'HasPosition': True, 'PosX': self.position_x, 'PosY': self.position_y, 'PosZ': self.position_z, 'RotX': self.rotation_x, 'RotY': self.rotation_y, 'RotZ': self.rotation_z, 'RotW': self.rotation_w}
